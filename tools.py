    ...
    for name, sym in indices.items():
        try:
            ...
            if not hist.empty:
                ...
                results[name] = {"value": round(cur, 2), "change_pct": round(pct, 2)}
        except:
            pass
    return results
...
def get_portfolio_pnl() -> dict:
    ...
    for ticker, pos in positions.items():
        ...
        day_change_usd = price_data["change"] * shares
        day_change_jpy = day_change_usd * usdjpy
        ...
        results.append({
            ...
            "day_change_usd": round(day_change_usd, 2),
            "day_change_jpy": round(day_change_jpy, 0),
